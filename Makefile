...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	$(CONTROLLER_GEN) rbac:roleName=alb-maintenance-manager-role crd webhook paths="./api/v1alpha1;./internal/controller" output:crd:artifacts:config=config/crd/bases
